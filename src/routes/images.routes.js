...
router.post('/:id', upload.array('image'), addFileUrls, userMiddlewares.isAuth, userMiddlewares.isWorkerOrAdmin, imageMiddlewares.createImage, imageController.createImage)
